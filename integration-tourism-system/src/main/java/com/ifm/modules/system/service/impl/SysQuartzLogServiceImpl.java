...
import com.ifm.modules.system.mapper.SysQuartzLogMapper;
...
*/
@Service
public class SysQuartzLogServiceImpl extends BaseServiceImpl<SysQuartzLogMapper, SysQuartzLog> implements ISysQuartzLogService {
    @Override
    public List<SysQuartzLog> listAll() {
        QueryWrapper<SysQuartzLog> queryWrapper = new QueryWrapper<>();
        return  baseMapper.selectList(queryWrapper);
    }

    @Override
    public Result add(SysQuartzLog entity) {
        if (entity == null) {
