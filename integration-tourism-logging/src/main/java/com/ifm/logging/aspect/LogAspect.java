package com.ifm.logging.aspect;


import com.ifm.comment.utils.RequestHolder;
...
public class LogAspect  {
    ...
    @Autowired
    public ISysLogService logService;
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(com.ifm.logging.annotation.Log)")
